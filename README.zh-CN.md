...
[English](https://github.com/timzou/cpp-headdoc/blob/main/README.md) | 简体中文
...
![C++ HeadDoc 在实现旁展开头文件文档](https://raw.githubusercontent.com/timzou/cpp-headdoc/main/images/inline-comments.png)
...
- 命令、配置说明、消息和文档字段支持英文与简体中文，并自动跟随 VS Code 界面语言。
...
| 命令 | 用途 |
| --- | --- |
| `C++ HeadDoc：刷新` | 清空缓存并刷新内联文档、CodeLens 和 Hover。 |
| `C++ HeadDoc：启用/禁用` | 切换当前工作区启用状态。 |
| `C++ HeadDoc：展开文档` | 展开光标所在实现的文档。 |
| `C++ HeadDoc：展开/折叠文档` | 切换内联文档状态。 |
| `C++ HeadDoc：打开 Markdown 预览` | 按需打开完整 Markdown 预览。 |
| `C++ HeadDoc：转到头文件声明` | 跳转到头文件声明。 |
| `C++ HeadDoc：检查环境` | 检查当前文件、CodeLens 和语言服务状态。 |
